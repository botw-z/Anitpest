    ...
    try {
        ...
        const requestBody = {
            contents: [{
                parts: [
                    {
                        text: "Without using bold text. When needed pesticide, provide what substaince needed in the pesticide. Detailed treatment steps. Analyze this plant image and identify if there are any pests. If you see pests, provide the following information in this exact format:\n\nPest Name: [pest name]\nDescription: [description, damage]\nSeverity Level: (Low/Moderate/High)\nRecommended Treatment:\n- [treatment step 1]\n- [treatment step 2]\n- [treatment step 3]\n\nIf you don't see any pests, respond with 'No pests detected' and explain what you see in the image."
                    },
                    {
                        inline_data: {
